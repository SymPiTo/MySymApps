...
/*_______________________________________________________________________ 
  ...
  _______________________________________________________________________ */
    ...
    public function Create()
    {
        ...
        IPS_SetInfo ($variablenID, "WSS"); 
        $variablenID =  $this->RegisterVariableInteger("ID_CPU_load1", "CPU load 1 min");
        IPS_SetInfo ($variablenID, "WSS"); 
        $variablenID =  $this->RegisterVariableInteger("ID_CPU_load5", "CPU load 5 min");
        IPS_SetInfo ($variablenID, "WSS"); 
        $variablenID =  $this->RegisterVariableInteger("ID_CPU_load15", "CPU load 15 min");
        IPS_SetInfo ($variablenID, "WSS"); 
